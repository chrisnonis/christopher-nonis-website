...
const Contact = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    window.location.href = `mailto:chrisnonis@live.co.uk?subject=${subject}&body=${body}`;
  };
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              <p className="text-light/80 text-lg mb-6">
                ...
                having a conversation about technology and innovation. Feel free to reach out!
              </p>
              <div className="space-y-4">
                <div className="flex items-center gap-4">
                  ...
                  <a href="mailto:chrisnonis@live.co.uk" className="text-light/80 hover:text-secondary">
                    chrisnonis@live.co.uk
                  </a>
                </div>
                <div className="flex items-center gap-4">
                  <svg
                  ...
                  <span className="text-light/80">Kent, UK</span>
                </div>
                <div className="flex gap-4 mt-6">
                  <a
                    href="https://github.com/chrisnonis"
                    target="_blank"
                  ...
                  <a
                    href="https://www.linkedin.com/in/christopher-nonis/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-light/70 hover:text-secondary transition-colors duration-200"
                  >
                  ...
                  <a
                    href="https://twitter.com/xda_remote"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-light/70 hover:text-secondary transition-colors duration-200"
                  >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full bg-primary/30 text-light rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-secondary"
                  />
                </div>
                <div>
